...
import {FumigatsiyaNazorati, ImagesTypesDocs} from '../../classes/interfaceDoc';
...
@Component({
  selector: 'app-fumigatsiya-nazorati',
  templateUrl: './fumigatsiya-nazorati.component.html',
  styleUrls: ['../../../assets/styles/Documents.css']
})
export class FumigatsiyaNazoratiComponent implements OnInit {
  ...
  selectedItem: FumigatsiyaNazorati;
  reloading = false;
  positionId: string;
  className = 'fumigatsiyaNazorati';
  list: FumigatsiyaNazorati;
  page = 1;
  pageSize = 20;
  totalPages: number;
  totalDocs: number;
  ...
  onSubmit() {
    const newFumigatsiyaNazorati: FumigatsiyaNazorati = {
      tasdiqlash: true,
    ...
    if (newFumigatsiyaNazorati) {
      ...
      fd.append('tasdiqlash', String(newFumigatsiyaNazorati.tasdiqlash));
      fd.append('tartibRaqam', String(newFumigatsiyaNazorati.tartibRaqam));
      fd.append('sana', String(newFumigatsiyaNazorati.sana));
      fd.append('yuridik', (newFumigatsiyaNazorati.yuridik ? String(newFumigatsiyaNazorati.yuridik) : String(false)));
      fd.append('jismoniy', (newFumigatsiyaNazorati.jismoniy ? String(newFumigatsiyaNazorati.jismoniy) : String(false)));
      fd.append('viloyatId', (newFumigatsiyaNazorati.viloyatId) ? newFumigatsiyaNazorati.viloyatId : '');
      fd.append('viloyatName', (newFumigatsiyaNazorati.viloyatName) ? newFumigatsiyaNazorati.viloyatName : '');
      fd.append('tumanId', (newFumigatsiyaNazorati.tumanId) ? newFumigatsiyaNazorati.tumanId : '');
      fd.append('tumanName', (newFumigatsiyaNazorati.tumanName) ? newFumigatsiyaNazorati.tumanName : '');
      fd.append('massivId', (newFumigatsiyaNazorati.massivId) ? newFumigatsiyaNazorati.massivId : '');
      fd.append('massivName', (newFumigatsiyaNazorati.massivName) ? newFumigatsiyaNazorati.massivName : '');
      fd.append('fermerXujaligiId', (newFumigatsiyaNazorati.fermerXujaligiId) ? newFumigatsiyaNazorati.fermerXujaligiId : '');
      fd.append('fermerXujaligiName', (newFumigatsiyaNazorati.fermerXujaligiName) ? newFumigatsiyaNazorati.fermerXujaligiName : '');
      fd.append('raxbari', (newFumigatsiyaNazorati.raxbari) ? newFumigatsiyaNazorati.raxbari : '');
      fd.append('qfyId', (newFumigatsiyaNazorati.qfyId) ? newFumigatsiyaNazorati.qfyId : '');
      fd.append('qfyName', (newFumigatsiyaNazorati.qfyName) ? newFumigatsiyaNazorati.qfyName : '');
      fd.append('mfyId', (newFumigatsiyaNazorati.mfyId) ? newFumigatsiyaNazorati.mfyId : '');
      fd.append('mfyName', (newFumigatsiyaNazorati.mfyName) ? newFumigatsiyaNazorati.mfyName : '');
      fd.append('xonadon', (newFumigatsiyaNazorati.xonadon) ? newFumigatsiyaNazorati.xonadon : '');
      fd.append('faoliyatTuriId', (newFumigatsiyaNazorati.faoliyatTuriId) ? newFumigatsiyaNazorati.faoliyatTuriId : '');
      fd.append('faoliyatTuriName', (newFumigatsiyaNazorati.faoliyatTuriName) ? newFumigatsiyaNazorati.faoliyatTuriName : '');
      fd.append('faoliyatYunalishlariId', (newFumigatsiyaNazorati.faoliyatYunalishlariId) ? newFumigatsiyaNazorati.faoliyatYunalishlariId : '');
      fd.append('faoliyatYunalishlariName', (newFumigatsiyaNazorati.faoliyatYunalishlariName) ? newFumigatsiyaNazorati.faoliyatYunalishlariName : '');
      fd.append('kasalliklarTuriId', (newFumigatsiyaNazorati.kasalliklarTuriId) ? newFumigatsiyaNazorati.kasalliklarTuriId : '');
      fd.append('kasalliklarId', (newFumigatsiyaNazorati.kasalliklarId) ? newFumigatsiyaNazorati.kasalliklarId : '');
      fd.append('zararkunandalarTuriId', (newFumigatsiyaNazorati.zararkunandalarTuriId) ? newFumigatsiyaNazorati.zararkunandalarTuriId : '');
      fd.append('zararkunandalarId', (newFumigatsiyaNazorati.zararkunandalarId) ? newFumigatsiyaNazorati.zararkunandalarId : '');
      fd.append('labaratoriya', (newFumigatsiyaNazorati.labaratoriya ? String(newFumigatsiyaNazorati.labaratoriya) : String(false)));
      fd.append('labaratoriyaXulosasi', (newFumigatsiyaNazorati.labaratoriyaXulosasi) ? newFumigatsiyaNazorati.labaratoriyaXulosasi : '');
      fd.append('xodimId', (newFumigatsiyaNazorati.xodimId) ? newFumigatsiyaNazorati.xodimId : '');
      fd.append('xodimName', (newFumigatsiyaNazorati.xodimName) ? newFumigatsiyaNazorati.xodimName : '');
      fd.append('vakilFIO', (newFumigatsiyaNazorati.vakilFIO) ? newFumigatsiyaNazorati.vakilFIO : '');
      fd.append('obektUlchami', (newFumigatsiyaNazorati.obektUlchami) ? newFumigatsiyaNazorati.obektUlchami : '');
      fd.append('obektXarorati', (newFumigatsiyaNazorati.obektXarorati) ? newFumigatsiyaNazorati.obektXarorati : '');
      fd.append('boshlanishVaqti', (newFumigatsiyaNazorati.boshlanishVaqti) ? String(newFumigatsiyaNazorati.boshlanishVaqti) : '');
      fd.append('tugashVaqti', (newFumigatsiyaNazorati.tugashVaqti) ? String(newFumigatsiyaNazorati.tugashVaqti) : '');
      fd.append('ekspozitsiya', (newFumigatsiyaNazorati.ekspozitsiya) ? String(newFumigatsiyaNazorati.ekspozitsiya) : '');
      fd.append('degezatsiya', (newFumigatsiyaNazorati.degezatsiya) ? newFumigatsiyaNazorati.degezatsiya : '');
      fd.append('fumigatsiyaTuriId', (newFumigatsiyaNazorati.fumigatsiyaTuriId) ? newFumigatsiyaNazorati.fumigatsiyaTuriId : '');
      fd.append('fumigatsiyaTuriName', (newFumigatsiyaNazorati.fumigatsiyaTuriName) ? newFumigatsiyaNazorati.fumigatsiyaTuriName : '');
      fd.append('fumigatsiyaForSpravochnikId', (newFumigatsiyaNazorati.fumigatsiyaForSpravochnikId) ? newFumigatsiyaNazorati.fumigatsiyaForSpravochnikId : '');
      fd.append('fumigatsiyaForSpravochnikName', (newFumigatsiyaNazorati.fumigatsiyaForSpravochnikName) ? newFumigatsiyaNazorati.fumigatsiyaForSpravochnikName : '');
      fd.append('narxi', (newFumigatsiyaNazorati.narxi) ? String(newFumigatsiyaNazorati.narxi) : '');
      fd.append('jamiSumma', (newFumigatsiyaNazorati.jamiSumma) ? String(newFumigatsiyaNazorati.jamiSumma) : '');
      fd.append('preparatlarId', (newFumigatsiyaNazorati.preparatlarId) ? newFumigatsiyaNazorati.preparatlarId : '');
      fd.append('preparatlarName', (newFumigatsiyaNazorati.preparatlarName) ? newFumigatsiyaNazorati.preparatlarName : '');
      fd.append('dozirovka', (newFumigatsiyaNazorati.dozirovka) ? String(newFumigatsiyaNazorati.dozirovka) : '');
      fd.append('preparatXajmi', (newFumigatsiyaNazorati.preparatXajmi) ? String(newFumigatsiyaNazorati.preparatXajmi) : '');
      fd.append('bioIndikator', (newFumigatsiyaNazorati.bioIndikator) ? newFumigatsiyaNazorati.bioIndikator : '');
      fd.append('natijaXulosa', (newFumigatsiyaNazorati.natijaXulosa) ? newFumigatsiyaNazorati.natijaXulosa : '');
      fd.append('afBlankaNomer', (newFumigatsiyaNazorati.afBlankaNomer) ? newFumigatsiyaNazorati.afBlankaNomer : '');
      fd.append('fumigatorId', (newFumigatsiyaNazorati.fumigatorId) ? newFumigatsiyaNazorati.fumigatorId : '');
      fd.append('fumigatorName', (newFumigatsiyaNazorati.fumigatorName) ? newFumigatsiyaNazorati.fumigatorName : '');
      fd.append('fumigatsiyaObyekt', (newFumigatsiyaNazorati.fumigatsiyaObyekt) ? newFumigatsiyaNazorati.fumigatsiyaObyekt : '');
      fd.append('ishlatilganPreparatXajmi', (newFumigatsiyaNazorati.ishlatilganPreparatXajmi) ? String(newFumigatsiyaNazorati.ishlatilganPreparatXajmi) : '');
    ...
    if (this.data1 < this.data2 || this.data1 === this.data2) {
      for (let i = this.data1; i < this.data2; i++) {
        if (this.s === 0) {
          ...
          this.xaqiqiySana = Math.round(this.xaqiqiySana + natija);
          this.s = this.s + 1;
        } else {
          this.xaqiqiySana = Math.round(this.xaqiqiySana + 24);
        }
      }
    } else {
      let soatTug = Number(vaqt.target.value.slice(11, 13));
      ...
      this.xaqiqiySana = Math.round(natija);
    }
  }
