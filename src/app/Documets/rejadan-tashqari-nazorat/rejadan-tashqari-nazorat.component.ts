...
import {ImagesTypesDocs, PlanKiritish, RejadanTashqariNazorat} from '../../classes/interfaceDoc';
...
@Component({
  selector: 'app-rejadan-tashqari-nazorat',
  templateUrl: './rejadan-tashqari-nazorat.component.html',
  styleUrls: ['../../../assets/styles/Documents.css']
})
export class RejadanTashqariNazoratComponent implements OnInit {
  ...
  selectedItem: RejadanTashqariNazorat;
  reloading = false;
  positionId: string;
  className = 'rejadanTashqariNazorat';
  list: RejadanTashqariNazorat;
  page = 1;
  pageSize = 20;
  totalPages: number;
  totalDocs: number;
  ...
  onSubmit() {
    const newRejadanTashqariNazorat: RejadanTashqariNazorat = {
      tasdiqlash: true,
    ...
    if (newRejadanTashqariNazorat) {
      ...
      fd.append('tasdiqlash', String(newRejadanTashqariNazorat.tasdiqlash));
      fd.append('tartibRaqam', String(newRejadanTashqariNazorat.tartibRaqam));
      fd.append('sana', String(newRejadanTashqariNazorat.sana));
      fd.append('yuridik', (newRejadanTashqariNazorat.yuridik ? String(newRejadanTashqariNazorat.yuridik) : String(false)));
      fd.append('jismoniy', (newRejadanTashqariNazorat.jismoniy ? String(newRejadanTashqariNazorat.jismoniy) : String(false)));
      fd.append('viloyatId', (newRejadanTashqariNazorat.viloyatId) ? newRejadanTashqariNazorat.viloyatId : '');
      fd.append('viloyatName', (newRejadanTashqariNazorat.viloyatName) ? newRejadanTashqariNazorat.viloyatName : '');
      fd.append('tumanId', (newRejadanTashqariNazorat.tumanId) ? newRejadanTashqariNazorat.tumanId : '');
      fd.append('tumanName', (newRejadanTashqariNazorat.tumanName) ? newRejadanTashqariNazorat.tumanName : '');
      fd.append('massivId', (newRejadanTashqariNazorat.massivId) ? newRejadanTashqariNazorat.massivId : '');
      fd.append('massivName', (newRejadanTashqariNazorat.massivName) ? newRejadanTashqariNazorat.massivName : '');
      fd.append('fermerXujaligiId', (newRejadanTashqariNazorat.fermerXujaligiId) ? newRejadanTashqariNazorat.fermerXujaligiId : '');
      fd.append('fermerXujaligiName', (newRejadanTashqariNazorat.fermerXujaligiName) ? newRejadanTashqariNazorat.fermerXujaligiName : '');
      fd.append('qfyId', (newRejadanTashqariNazorat.qfyId) ? newRejadanTashqariNazorat.qfyId : '');
      fd.append('qfyName', (newRejadanTashqariNazorat.qfyName) ? newRejadanTashqariNazorat.qfyName : '');
      fd.append('mfyId', (newRejadanTashqariNazorat.mfyId) ? newRejadanTashqariNazorat.mfyId : '');
      fd.append('mfyName', (newRejadanTashqariNazorat.mfyName) ? newRejadanTashqariNazorat.mfyName : '');
      fd.append('xonadon', (newRejadanTashqariNazorat.xonadon) ? newRejadanTashqariNazorat.xonadon : '');
      fd.append('faoliyatTuriId', (newRejadanTashqariNazorat.faoliyatTuriId) ? newRejadanTashqariNazorat.faoliyatTuriId : '');
      fd.append('faoliyatTuriName', (newRejadanTashqariNazorat.faoliyatTuriName) ? newRejadanTashqariNazorat.faoliyatTuriName : '');
      fd.append('faoliyatYunalishlariId', (newRejadanTashqariNazorat.faoliyatYunalishlariId) ? newRejadanTashqariNazorat.faoliyatYunalishlariId : '');
      fd.append('faoliyatYunalishlariName', (newRejadanTashqariNazorat.faoliyatYunalishlariName) ? newRejadanTashqariNazorat.faoliyatYunalishlariName : '');
      fd.append('yerMaydoni', String((newRejadanTashqariNazorat.yerMaydoni) ? newRejadanTashqariNazorat.yerMaydoni : '0'));
      fd.append('kasalliklarTuriId', (newRejadanTashqariNazorat.kasalliklarTuriId) ? newRejadanTashqariNazorat.kasalliklarTuriId : '');
      fd.append('kasalliklarId', (newRejadanTashqariNazorat.kasalliklarId) ? newRejadanTashqariNazorat.kasalliklarId : '');
      fd.append('begonaUtlarTuriId', (newRejadanTashqariNazorat.begonaUtlarTuriId) ? newRejadanTashqariNazorat.begonaUtlarTuriId : '');
      fd.append('begonaUtlarId', (newRejadanTashqariNazorat.begonaUtlarId) ? newRejadanTashqariNazorat.begonaUtlarId : '');
      fd.append('zararkunandalarTuriId', (newRejadanTashqariNazorat.zararkunandalarTuriId) ? newRejadanTashqariNazorat.zararkunandalarTuriId : '');
      fd.append('zararkunandalarId', (newRejadanTashqariNazorat.zararkunandalarId) ? newRejadanTashqariNazorat.zararkunandalarId : '');
      fd.append('topildi', (newRejadanTashqariNazorat.topildi ? String(newRejadanTashqariNazorat.topildi) : String(false)));
      fd.append('topilmadi', (newRejadanTashqariNazorat.topilmadi ? String(newRejadanTashqariNazorat.topilmadi) : String(false)));
      fd.append('xulosa', (newRejadanTashqariNazorat.xulosa) ? newRejadanTashqariNazorat.xulosa : '');
      fd.append('muddati', String((newRejadanTashqariNazorat.muddati) ? newRejadanTashqariNazorat.muddati : '0'));
      fd.append('kurashUsullariId', (newRejadanTashqariNazorat.kurashUsullariId) ? newRejadanTashqariNazorat.kurashUsullariId : '');
      fd.append('kurashishUsuliXulosasi', (newRejadanTashqariNazorat.kurashishUsuliXulosasi) ? newRejadanTashqariNazorat.kurashishUsuliXulosasi : '');
      fd.append('labaratoriya', (newRejadanTashqariNazorat.labaratoriya ? String(newRejadanTashqariNazorat.labaratoriya) : String(false)));
      fd.append('labaratoriyaXulosasi', (newRejadanTashqariNazorat.labaratoriyaXulosasi) ? newRejadanTashqariNazorat.labaratoriyaXulosasi : '');
      fd.append('kurilganYerMaydoni', String((newRejadanTashqariNazorat.kurilganYerMaydoni) ? newRejadanTashqariNazorat.kurilganYerMaydoni : '0'));
      fd.append('xodimId', (newRejadanTashqariNazorat.xodimId) ? newRejadanTashqariNazorat.xodimId : '');
      fd.append('xodimName', (newRejadanTashqariNazorat.xodimName) ? newRejadanTashqariNazorat.xodimName : '');
      fd.append('foydalanuvchiId', (newRejadanTashqariNazorat.foydalanuvchiId) ? newRejadanTashqariNazorat.foydalanuvchiId : '');
  ...
  creatAll(ObjectForm) {
    if (this.positionId) {
      ...
      this.apiService.updated<RejadanTashqariNazorat>(this.className, ObjectForm, ObjectForm._id)
        .subscribe(
      ...
      this.apiService.creted<RejadanTashqariNazorat>(this.className, ObjectForm)
        .subscribe(
  ...
  getAll() {
    ...
    this.apiService.getAllByPagePost<PageResponse<RejadanTashqariNazorat>>(params, this.className)
      .subscribe(result => {
  ...
  getByFilter() {
    ...
    this.apiService.getFilter<PageResponse<RejadanTashqariNazorat>>(params, this.className)
      .subscribe(result => {
        this.list = result.content;
        this.totalDocs = result.totalDocs;
        this.hasPrevPage = result.hasPrevPage;
